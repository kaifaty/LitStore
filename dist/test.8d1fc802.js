...
var LitState = /*#__PURE__*/function (_LitElement) {
  _inherits(LitState, _LitElement);

  var _super = _createSuper(LitState);

  function LitState() {
    var _this;

    _classCallCheck(this, LitState);

    _this = _super.apply(this, arguments);
    _this.usedStores = new Set();
    return _this;
  }

  _createClass(LitState, [{
    key: "disconnectedCallback",
    value: function disconnectedCallback() {
      _get(_getPrototypeOf(LitState.prototype), "disconnectedCallback", this).call(this);
    ...
    value: function update(changedProperties) {
      ...
      _get(_getPrototypeOf(LitState.prototype), "update", this).call(this, changedProperties);
    ...
    value: function _initStateObservers() {
      ...
      var usedStores = _store.stateRecorder.finish();

      this._addObservers(usedStores);
    }
  }, {
    key: "_addObservers",
    ...
    value: function _clearObservers() {
      var _iterator2 = _createForOfIteratorHelper(this.usedStores),
          _step2;
...
},{"lit-element":"node_modules/lit-element/lit-element.js","./store":"src/store.ts"}],"test.ts":[function(require,module,exports) {
"use strict";

var _store = require("./src/store");

var _litState = require("./src/lit-state");
...
var MyComponent = /*#__PURE__*/function (_LitState) {
  _inherits(MyComponent, _LitState);
  ...
  _createClass(MyComponent, [{
    ...
    value: function render() {
      return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n            <div>\n                ", "\n            </div>           \n            <button @click=", ">Inc</button>\n            <button @click=", ">toggle</button>\n        "])), state.isHidden ? "" : (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<h1>Counter: ", "</h1>"])), state.counter), function () {
...
MyComponent = __decorate([(0, _litElement.customElement)("test-comp")], MyComponent);
},{"./src/store":"src/store.ts","./src/lit-state":"src/lit-state.ts","lit-element":"node_modules/lit-element/lit-element.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","test.ts"], null)
